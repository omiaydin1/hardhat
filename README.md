...
Hardhat can be used to deploy and test smart contracts on the Base mainnet.
Base support allows developers to run realistic deployment scenarios
with reduced gas costs while keeping Ethereum tooling compatibility.
